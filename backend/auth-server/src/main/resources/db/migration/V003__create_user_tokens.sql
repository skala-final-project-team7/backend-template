...
--       Atlassian access token 은 2KB 초과 JWT(라이브 스모크 실측 2026-06-12) — 암호화(+28B) 포함 VARBINARY(8192) 로 잡는다.
...
CREATE TABLE user_tokens (
    ...
    confluence_access_token_enc  VARBINARY(8192) NOT NULL,
    confluence_refresh_token_enc VARBINARY(8192) NOT NULL,
